...
import { useWindowManager } from "../../../system/hooks/useWindowManager.ts";
import { Button } from "@base-ui/react";
import { useSystemCtl } from "../../../system/hooks/useSystemCtl.ts";
...
export const WindowFrame = memo(function WindowFrame({
  ...
  const handleSetWindowPosition = (position: OSWindow["position"]) => {
    executeWindowAction({
  ...
  const handleSetWindowSize = (size: OSWindow["size"]) => {
    executeWindowAction({
